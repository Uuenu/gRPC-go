...
type Keyboard struct {
	Layout               Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=lab.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
func init() {
	proto.RegisterEnum("lab.pcbook.Keyboard_Layout", Keyboard_Layout_name, Keyboard_Layout_value)
	proto.RegisterType((*Keyboard)(nil), "lab.pcbook.Keyboard")
}
...
var fileDescriptor_8fd4226b8635fe5d = []byte{
	...
	0x2f, 0xc9, 0x17, 0xe2, 0xca, 0x49, 0x4c, 0xd2, 0x2b, 0x48, 0x4e, 0xca, 0xcf, 0xcf, 0x56, 0x9a,
	...
	0x14, 0x58, 0x9c, 0xd9, 0x89, 0x35, 0x8a, 0x59, 0xbf, 0x20, 0x29, 0x89, 0x0d, 0xec, 0x60, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6d, 0x7d, 0x4a, 0x66, 0xca, 0x00, 0x00, 0x00,
}
