...
type Storage struct {
	Driver               Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=lab.pcbook.Storage_Driver" json:"driver,omitempty"`
...
func init() {
	proto.RegisterEnum("lab.pcbook.Storage_Driver", Storage_Driver_name, Storage_Driver_value)
	proto.RegisterType((*Storage)(nil), "lab.pcbook.Storage")
}
...
var fileDescriptor_170f09d838bd8a04 = []byte{
	...
	0xc9, 0x17, 0xe2, 0xca, 0x49, 0x4c, 0xd2, 0x2b, 0x48, 0x4e, 0xca, 0xcf, 0xcf, 0x96, 0x12, 0xc9,
	...
	0x23, 0x88, 0x11, 0xec, 0xe2, 0x22, 0xc0, 0xe4, 0xc4, 0x1a, 0xc5, 0xac, 0x5f, 0x90, 0x94, 0xc4,
	0x06, 0x76, 0xa2, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x44, 0x84, 0x63, 0xb7, 0xdd, 0x00, 0x00,
	0x00,
}
